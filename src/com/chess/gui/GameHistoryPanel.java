...
public class GameHistoryPanel extends JPanel{
	...
	void redo(final Board board, final MoveLog moveHistory) {
		...
		for (final Move move : moveHistory.getMove()) {
		...
		if (moveHistory.getMove().size() > 0) {
			final Move lastMove = moveHistory.getMove().get(moveHistory.size() - 1);
	...
	private static class DataModel extends DefaultTableModel {
		...
		private static final String[] NAMES = {"Whites", "Blacks"};
		...
		@Override
		public Class<?> getColumnClass(final int colunm) {
			return Move.class;
		}
